...
会話のID 1a（明示的な回答反復）と1b（意味確認・省略・言い換え）は実装済み。直近の話題を生活／仕事の原経験へ結び、本人／プレイヤー・元の時点・既知／未理解・本人発話／観察描写を区別する。対象範囲は[正本の1b節](core/experimental_word_learning.md#会話文脈の小単位1b意味確認省略言い換え)を参照。ID 1全体は未完で、次は1cの現実の出来事の部分理解・話題継続。
